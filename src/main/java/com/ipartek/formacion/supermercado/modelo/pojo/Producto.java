...
public class Producto {
	...
	public Producto(int id, String nombre, float precio, String imagen, String descripcion, int decuento) {
		super();
		this.id = id;
		this.nombre = nombre;
		this.precio = precio;
	...
	public float getprecioDecuento() {
		return (this.precio - (this.decuento * this.precio / 100));
	}
